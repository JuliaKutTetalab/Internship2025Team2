...
import com.example.growbox.screen.home.temperature_chart.model.ChartDataPoint
...
fun TemperatureChart(
    ...
    if (data.isEmpty()){
        Box(
            ...
            Text(
                text = stringResource(R.string.temperature_chart_no_data),
                color = Gray999
            )
        }
        return
